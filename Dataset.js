         ...
         myData.push(new MyCSV(data[index][0], data[index][1], data[index][2],
			...
			switch(Number(process.argv[2])){
				...
				case 5:
					...
					console.log(myData[stopLength.indexOf(Math.max.apply(Math, stopLength))], "Maximum Stops:"
								+ Math.max.apply(Math, stopLength));
					break;
				case 6:
					TraingroupBy(myData, 'trainname');
						Object.keys(trainStop[0]).forEach(ele => {
						...
						console.log(myData[stopLength.indexOf(Math.min.apply(Math, stopLength))], "Minimum Stops:"
						+ Math.min.apply(Math, stopLength));
					break;
				default:
