...
// Distance 2 over
    ...
    // myData.forEach((items) => {
    //     totalTrain.push(items.FieldOne); 
    // })
    // console.log(totalTrain);


////


    // function removeDuplicates(FieldOne) {
        
//         var lookupObject  = {};
   
//         for(var i in myData) {
//            lookupObject[myData[i][prop]] = myData[i];
//         }
   
//         for(i in lookupObject) {
//             myDataUnique.push(lookupObject[i]);
//         }
//          return myDataUnique;
//     }
